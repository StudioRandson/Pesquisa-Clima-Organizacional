            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" method="POST">
                    <span class="login100-form-title p-b-48">
                        <img class="logo mb-4" src="img/favicon.png" width="100" alt="Logo-Talentus">
                    </span>
                    <span class="login100-form-title p-b-26">Relatório</span>
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            <button class="login100-form-btn" type="submit">Acessar Relatório</button>
                        </div>
                    </div>
                    <div class="text-center p-t-115">
                        <a class="txt2" href="../index.php">Ir para a Pesquisa</a>
                    </div>
                </form>
            </div>
        </div>
